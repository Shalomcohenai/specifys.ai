...
/**
 * Merge generated stage bodies into the final full development prompt.
 */
export function assembleFullPrompt(generatedStages, overviewContent, technicalContent) {
...
Please build this application following best practices, ensuring scalability, security, and excellent user experience.`;
  ...
  try {
    ...
    /* placeholder replacement is best-effort */
  }

  return fullPrompt;
}

export function buildIntegrationsPrompt(overviewContent, technicalContent) {
