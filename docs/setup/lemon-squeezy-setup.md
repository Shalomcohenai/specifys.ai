...
**השגיאה:**
```
Access to fetch at 'https://specifys-ai-backend.onrender.com/api/lemon/counter' 
from origin 'https://specifys-ai.com' has been blocked by CORS policy
```

**הפתרון:**
1. הוספנו את `https://specifys-ai-backend.onrender.com` ל-`allowedOrigins`
...
3. **עדכן את ה-JavaScript:**
   ...
   // אבל שנה את ה-URLs:
   const API_BASE_URL = 'https://specifys-ai-backend.onrender.com/api';
