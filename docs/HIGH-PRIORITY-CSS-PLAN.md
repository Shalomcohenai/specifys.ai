...
### משימה 3: ✅ **הושלם!** (2025-12-11)
- [x] החלטה על SCSS כמקור
- [x] קימפול SCSS ל-CSS עבור כל הקבצים הכפולים (6 זוגות: buttons, badges, mermaid, display, spacing, text)
- [x] יצירת גיבוי של קבצי CSS ישנים
- [x] `head.html` משתמש ב-CSS (כבר היה נכון)
- [x] `_config.yml` משתמש ב-CSS (כבר היה נכון)
- [x] אין שימוש ב-.scss בדפים HTML
- [x] האתר עובד נכון
